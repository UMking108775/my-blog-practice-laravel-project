                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <fieldset class="fieldset">
                        ...
                        <input
                            ...
                            placeholder="Technology" value="{{ $category->name }}">
                    </fieldset>
                    ...
                    <fieldset class="fieldset">
                        ...
                        <input
                            ...
                            name="slug"
                            class="input input-bordered w-full"
                            placeholder="technology" value="{{ $category->slug }}">
                    ...
                    <fieldset class="fieldset lg:col-span-2">
                        ...
                        <input
                            type="file"
                            name="featured_image"
                            class="file-input file-input-bordered w-full" value="{{ $category->featured_image }}">
                            image: <img src="{{ asset('images/' . $category->featured_image) }}" alt="Category Image" class="w-20 h-20 mt-2">
                    </fieldset>
                    ...
                    <fieldset class="fieldset lg:col-span-2">
                        ...
                        <textarea
                            ...
                            placeholder="Write a short description about this category...">{{ $category->description }}</textarea>
                    </fieldset>
